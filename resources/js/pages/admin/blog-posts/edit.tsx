...
export default function EditBlogPost({ post }: Props) {
    ...
    const handleTitleChange = (title: string) => {
        ...
        const currentSlug = generateSlug(post.title);
    ...
    return (
        <AppShell>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900">✏️ Edit Blog Post</h1>
                    <p className="text-gray-600 mt-1">Update your SEO-optimized blog post</p>
                </div>
